...
public class FenBiblio extends JFrame {
	...
	private final JRadioButton rdbtnBD = new JRadioButton("Bande Dessinée");
	...
	private class BtnSupprimerActionListener implements ActionListener { // boutons qui supprime le livre associ� au
																			// code s�lectionn�
		@Override
		public void actionPerformed(ActionEvent e) {
